...
export default function Weather(props) {
  ...
  function currentLocation(position) {
    let locationApiUrl = `https://api.openweathermap.org/data/3.0/onecall?lat=${position.coords.latitude}&lon=${position.coords.longitude}&appid=63b79185d21891dc86fad86aa0ab0b0b&units=metric`;
